  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(45893114U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1830511565U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1786978807U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3666496547U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2137876310U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2435327301U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1590763962U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3004630614U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 4:
      {
        if (strcmp(instanceChksum, "swsxN6944wtzQfdjaXMgK0") == 0) {
          extern const mxArray
            *sf_c4_flightControlSystem_get_eml_resolved_functions_info(void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c4_flightControlSystem_get_eml_resolved_functions_info();
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 4:
      {
        if (strcmp(tpChksum, "swsxN6944wtzQfdjaXMgK0") == 0) {
