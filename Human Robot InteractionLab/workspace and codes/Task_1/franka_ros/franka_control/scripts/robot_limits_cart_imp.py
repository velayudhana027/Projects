...
def set_limits():
	...
	ctrl1 = 'cartesian_impedance_example_controller'
...
def set_limits_full():
	...
	behavior.lower_torque_thresholds_nominal = [40.0] * 7
	behavior.upper_torque_thresholds_nominal = [40.0] * 7
	behavior.lower_force_thresholds_nominal = [40.0] * 6
	behavior.upper_force_thresholds_nominal = [40.0] * 6
	behavior.lower_torque_thresholds_acceleration = [40.0] * 7
	behavior.upper_torque_thresholds_acceleration = [40.0] * 7
	behavior.lower_force_thresholds_acceleration = [40.0] * 6
	behavior.upper_force_thresholds_acceleration = [40.0] * 6
	res2 = collisionService(behavior)
	print("Collision behavior changed")
	print(behavior)
